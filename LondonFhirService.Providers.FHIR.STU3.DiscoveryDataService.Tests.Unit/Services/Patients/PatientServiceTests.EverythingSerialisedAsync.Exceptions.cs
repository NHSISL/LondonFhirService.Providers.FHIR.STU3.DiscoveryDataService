...
namespace LondonFhirService.Providers.FHIR.STU3.DiscoveryDataService.Tests.Unit.Services.Patients
{
    public partial class PatientServiceTests
    {
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnEverythingSerialisedWhenCancellationRequestedAsync()
        {
            // given
            string randomNhsNumber = GetRandomString();
            string inputNhsNumber = randomNhsNumber;
            ...
            PatientDependencyException actualException =
                await Assert.ThrowsAsync<PatientDependencyException>(everythingSerialisedTask.AsTask);
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnEverythingSerialisedWhenNetworkFailureAsync()
        {
            // given
            string randomNhsNumber = GetRandomString();
            string inputNhsNumber = randomNhsNumber;
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnEverythingSerialisedWhenHttpRequestExceptionOccursAsync()
        {
            // given
            string randomNhsNumber = GetRandomString();
            string inputNhsNumber = randomNhsNumber;
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnEverythingSerialisedWhenInvalidOperationExceptionOccursAsync()
        {
            // given
            string randomNhsNumber = GetRandomString();
            string inputNhsNumber = randomNhsNumber;
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnEverythingSerialisedWhenHttpRequestExceptionHasStatusCodeAsync()
        {
            // given
            string randomNhsNumber = GetRandomString();
            string inputNhsNumber = randomNhsNumber;
